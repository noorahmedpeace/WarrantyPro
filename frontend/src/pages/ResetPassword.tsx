        ...
        return (
            <LoginLayout title="INVALID LINK" subtitle="This password reset link is invalid or expired">
                <div className="space-y-8 text-center">
                    <div className="flex flex-col items-center gap-4 rounded-surface border border-expired bg-expired-wash p-6">
                        <AlertCircle className="h-12 w-12 text-expired" strokeWidth={2.5} />
                        <p className="text-center text-lg font-bold text-expired">We couldn't verify your request.</p>
                        <p className="text-center text-sm font-medium text-expired">Please request a new link.</p>
                    </div>
                    <Link to="/forgot-password" className="inline-block rounded-control border border-accent bg-accent px-8 py-3.5 font-semibold text-on-accent transition-all hover:-translate-y-0.5">
                        Request New Link
                    </Link>
                </div>
            </LoginLayout>
        ...
        >
            {status === 'success' ? (
                <div className="space-y-6 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <Link to="/login" className="inline-flex items-center gap-2 rounded-control border border-accent bg-accent px-8 py-3.5 font-semibold text-on-accent transition-all hover:-translate-y-0.5">
