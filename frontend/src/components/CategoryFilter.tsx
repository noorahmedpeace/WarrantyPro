...
export const CategoryFilter: React.FC<CategoryFilterProps> = ({ categories, selected, onSelect }) => {
    return (
        <div className="rounded-[1.6rem] bg-slate-50 px-4 py-4 shadow-[0_18px_40px_rgba(15,23,42,0.05)] sm:rounded-[1.8rem] sm:px-5 sm:py-5">
                ...
                {categories.map((category) => {
                    ...
                    return (
                        <button
                            ...
                            className={`min-h-11 whitespace-nowrap rounded-full px-4 py-2.5 text-[0.68rem] font-semibold uppercase tracking-[0.24em] transition-all duration-200 ${
                                isSelected
